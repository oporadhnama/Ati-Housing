      ...
      <AnimatePresence>
        {showBackToTop && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="fixed bottom-[184px] right-6 z-40 w-10 h-10 flex items-center justify-center bg-brand-gold hover:bg-brand-gold-dark text-brand-navy rounded-full shadow-lg shadow-brand-gold/25 transition-colors duration-200 focus-visible:outline-white"
